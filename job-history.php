...
<body>
	...
	<section class="job-area section-gap-top section-gap-bottom-90">
		<div class="container">
			...
			<p class="job-history-year">2019 - 2020</p>
			<div class="row">
				<div class="col-lg-6">
			...
			<p class="job-history-year">2018 - 2019</p>
			<div class="row">
				<div class="col-lg-6">
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
			...
			<p class="job-history-year">2017 - 2018</p>
			<div class="row">
				<div class="col-lg-6">
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
			...
			<p class="job-history-year">2011 - 2014</p>
			<div class="row">
				<div class="col-lg-6">
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								...
								<p>AG2R La Mondiale, Mons-en-baroeul</p>
							</div>
							<div class="top-right">
				...
				<div class="col-lg-6">
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								<h4>Administrative agent</h4>
								<p>Crédit Agricole Nord De France, Lille</p>
							</div>
							<div class="top-right">
				...
				<div class="col-lg-6">
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								<h4>Pricing analyst</h4>
								<p>Quinton Hazell, Lesquin</p>
							</div>
							<div class="top-right">
					...
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								...
								<p>Transpole, Villeneuve d'Ascq</p>
							</div>
							<div class="top-right">
